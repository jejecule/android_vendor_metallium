...
ifneq ($(filter metallium_bacon metallium_cancro metallium_find7 metallium_jactivelte metallium_d802,$(TARGET_PRODUCT)),)
    PRODUCT_COPY_FILES += \
...
ifneq ($(filter metallium_armani metallium_falcon metallium_lettuce metallium_n7100 metallium_mako metallium_tilapia,$(TARGET_PRODUCT)),)
    PRODUCT_COPY_FILES += \
